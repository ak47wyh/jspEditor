        ...
        ajax: function(e) {
            ...
            function() {
                ...
                r && ("string" == typeof r ? r = function(e) {
                    for (var t = e.split("&"), n = 0, i = t.length; n < i; n++) name = encodeURIComponent(t[n].split("=")[0]),
                ...
                default(n, {
                    ...
                    default.zh,
                        onChange: function(t, o, r) {
                            "" === o ? (n.innerText = e.DESCNAME, e.VALUE = "", i.setAttribute("sde-model", JSON.stringify(e))) : (n.innerText = o, e.VALUE = o, i.setAttribute("sde-model", JSON.stringify(e)))
                        }
                    }).open(),
                    0 === e.READONLY && u()
                }
...
default = {
        ...
        click: function(e) {
            if (void 0 === e.READONLY || 1 !== e.READONLY) {
                ...
                if (0 !== t.length) {
                    var n = t[0];
                    n.innerText === e.DESCNAME && (n.innerText = ""),
                    a(n) || (o.
                default.registerEvent(n, "DOMCharacterDataModified", s), o.
                default.registerEvent(n, "blur", l), r.push(n)),
                    d(e,
                    function(t) {
            ...
            function() {
                ...
                function D(t, n) {
                    ...
                    if (a.exec(t)) {
                        ...
                        return d && T.call(this, e.util.getTopBlockContainer(d)),
                        c
                    }
                    return o = n && n.value,
                ...
                e.prototype = {
                    init: function(e, t) {
                        return this.options = E.call(this, this.defaults, t),
                        this.origElements = e,
                        this.options.elementsContainer || (this.options.elementsContainer = this.options.ownerDocument.body),
                        this.setup()
                    },
                    setup: function() {
                        this.isActive || (s.call(this, this.options.contentWindow), this.events = new e.Events(this), this.elements = [], this.addElements(this.origElements), 0 !== this.elements.length && (this.isActive = !0, C.call(this), x.call(this)))
                    },
                    destroy: function() {
                    ...
                    resetContent: function(e) {
                        if (e) {
                            ...
                            return void( - 1 !== t && this.setContent(A[e.getAttribute("medium-editor-index")], t))
                        }
...
default],
    ...
    T = function(e) {
        for (var t = 0,
        n = e.length; t < n; t++) S.call(this, e[t])
    },
    A = function(e, t) {
        ...
        if (e.TYPE && "" !== e.TYPE || (e.TYPE = i.TYPE), "select" === e.TYPE) {
            ...
            else if (0 === i.BINDINGDATA.length) console.error("id为" + e.ID + "控件BINDINGDATA数据为0，请赋予该控件TEXT值！");
            else for (var a = 0,
    ...
    S = function(e) {
        for (var t = this.__dom__.querySelectorAll("#" + e.ID), n = 0, i = t.length; n < i; n++) A(e, t[n])
    },
    N = function(e) {
    ...
    M = function(e) {
        ...
        if ("text" === i.TYPE) {
            var o = t.getElementsByClassName("sde-value")[0];
            "" !== o && o !== i.VALUE && o.innerText !== i.DESCNAME && (i.VALUE = o.innerText, t.setAttribute("sde-model", JSON.stringify(i)))
        }
        return i
    },
    L = function() {
        for (var e = this.__dom__.getElementsByClassName("sde-value"), t = [], n = 0, i = e.length; n < i; n++) {
    ...
    if (window.SDE = function(e) {
        ...
        e = r.
    default.deepCopy(s.
    default.defaultOptions, e);
        var t = void 0;
        if (void 0 === e.id) t = document.body;
        else if (void 0 === (t = document.getElementById(e.id)) || void 0 === t) return void console.error("can not find iframe`s id element!");
        ...
        function(e) {
            if ("READONLY" !== i.__options__.mode) {
                ...
                if (null !== t && ("INPUT" === t.tagName && "checkbox" === t.type && "LABEL" === t.parentNode.tagName && (t = t.parentNode.parentNode), null === t.getAttribute("sde-model") && (t = t.parentNode), null === t.getAttribute("sde-model") && (t = t.parentNode), null !== t && "#document" !== t.nodeName && null !== t.getAttribute("sde-model"))) {
                    ...
                    var o = n.TYPE;
                    O() && !window.__is_sde_iframe__ && (o = n.TYPE + ".mobile");
                    for (var r = 0,
                    a = E.length; r < a; r++) {
                        var s = E[r];
                        if (s.TYPE === o) {
    ...
    default.registerEvent(t, "keydown",
        function(e) {
            if (13 === (e.keyCode || e.which) && null !== e.target.parentNode.getAttribute("sde-model")) return e.preventDefault ? e.preventDefault() : e.returnValue = !1,
        ...
        function(t) {
            ...
            if (null === n && i.getAttribute("sde-model") ? n = JSON.parse(i.getAttribute("sde-model")) : null === n && (i = i.parentNode), null === n && i.getAttribute("sde-model") ? n = JSON.parse(i.getAttribute("sde-model")) : null === n && (i = i.parentNode), null === n && i.getAttribute("sde-model") ? n = JSON.parse(i.getAttribute("sde-model")) : null === n && (i = i.parentNode), null !== n) {
                ...
                if (1 !== n.READONLY && ("text" === n.TYPE || "date" === n.TYPE || "select" === n.TYPE && n.FREEINPUT && 1 === n.FREEINPUT)) {
                    ...
                    i.getElementsByClassName("sde-value")[0].innerText = r,
                    n.VALUE = r,
                    i.setAttribute("sde-model", JSON.stringify(n))
                }
                for (var a = i.getElementsByClassName("sde-select-root"), s = 0, l = a.length; s < l; s++) a[s].remove();
                return t.preventDefault ? t.preventDefault() : t.returnValue = !1,
                !1
            }
        })),
        N.call(this, e.mode),
        void 0 !== e.controls && e.controls.length > 0 && T.call(this, e.controls)
    },
    window.SDE.prototype = {
        constructor: window.SDE,
        html: function(e) {
            if (void 0 === e) {
                for (var t = this.__dom__,
                n = t.getElementsByClassName("flatpickr-calendar"), i = 1, o = n.length, r = o - 1; r >= 0; r--) n[r].remove(),
                console.log("第" + i+++"次");
                return (R(t.children) ? t.innerHTML + '<p class="end-dom"> </p>': t.innerHTML).replace(/\u200B/g, "")
            }
        ...
        setControl: function(e) {
            null !== e && void 0 !== e && "" !== e && (r.
        default.isArray(e) ? T.call(this, e) : r.
        default.isPlainObject(e) && S.call(this, e))
        },
        getControl: function(e) {
            return void 0 === e ? L.call(this) : M.call(this, e)
        },
    ...
    window.sdeoptions) {
        var P = new SDE(window.sdeoptions);
        window.sde = P,
...
function(e, t, n) {
    ...
    function i(e, t) {
        ...
        function f() {
            ...
            if (ye.debouncedResize = ge(j, 50), ye.triggerChange = function() {
                oe("Change")
            },
        ...
        function k() {
            ...
            ye.config.noCalendar || (e.appendChild(A()), ye.innerContainer = fe("div", "flatpickr-innerContainer"), ye.config.weekNumbers && ye.innerContainer.appendChild(M()), ye.rContainer = fe("div", "flatpickr-rContainer"), ye.rContainer.appendChild(N()), ye.daysContainer || (ye.daysContainer = fe("div", "flatpickr-days"), ye.daysContainer.tabIndex = -1), D(), ye.rContainer.appendChild(ye.daysContainer), ye.innerContainer.appendChild(ye.rContainer), e.appendChild(ye.innerContainer)),
        ...
        function D(e) {
            ...
            a = 0;
            for (ye.config.weekNumbers && ye.weekNumbers.firstChild && (ye.weekNumbers.textContent = ""), n && (ye.minRangeDate = new Date(ye.currentYear, ye.currentMonth - 1, r), ye.maxRangeDate = new Date(ye.currentYear, ye.currentMonth + 1, (42 - t) % i)); r <= ye.prevMonthDays; r++, a++) o.appendChild(x("prevMonthDay", new Date(ye.currentYear, ye.currentMonth - 1, r), r, a));
            for (r = 1; r <= i; r++, a++) o.appendChild(x("", new Date(ye.currentYear, ye.currentMonth, r), r, a));
            for (var s = i + 1; s <= 42 - t; s++, a++) o.appendChild(x("nextMonthDay", new Date(ye.currentYear, ye.currentMonth + 1, s % i), s, a));
            ...
            if (n || r || a) {
                ...
                case "ArrowRight":
                    if (!l) if (e.preventDefault(), ye.daysContainer) {
                        ...
                        e.ctrlKey ? L(c, !0) : C(e.target.$i, c)
                ...
                case "ArrowDown":
                    ...
                    ye.daysContainer ? e.ctrlKey ? (B(ye.currentYear - d), C(e.target.$i, 0)) : l || C(e.target.$i, 7 * d) : ye.config.enableTime && (l || ye.hourElement.focus(), o(e));
                    break;
                case "Tab":
        ...
        function j() { ! ye.isOpen || ye.config.static || ye.config.inline || q()
        }
        function U(e) {
            ...
            0),
            void oe("Open");
            ye.isOpen || ye._input.disabled || ye.config.inline || (ye.isOpen = !0, ye.calendarContainer.classList.add("open"), q(), ye._input.classList.add("active"), oe("Open"))
        }
        function z(e) {
            return function(t) {
                ...
                ye.daysContainer && (V(), o ? ye.currentYearElement[e] = n.getFullYear() : ye.currentYearElement.removeAttribute(e), ye.currentYearElement.disabled = i && n && i.getFullYear() === n.getFullYear())
            }
        }
        function W() {
        ...
        function J(e) {
            if (e.preventDefault(), e.stopPropagation(), e.target.classList.contains("flatpickr-day") && !e.target.classList.contains("disabled") && !e.target.classList.contains("notAllowed")) {
                ...
                50), "range" === ye.config.mode && (1 === ye.selectedDates.length ? (Y(e.target), ye._hidePrevMonthArrow = ye._hidePrevMonthArrow || ye.minRangeDate > ye.days.childNodes[0].dateObj, ye._hideNextMonthArrow = ye._hideNextMonthArrow || ye.maxRangeDate < new Date(ye.currentYear, ye.currentMonth + 1, 1)) : le()), oe("Change"), n ? E(function() {
                    return ye.selectedDateElem.focus()
                }) : C(e.target.$i, 0), ye.config.enableTime && setTimeout(function() {
        ...
        function he(e) {
            ...
            t || n ? L(t ? -1 : 1) : e.target === ye.currentYearElement ? (e.preventDefault(), ye.currentYearElement.select()) : "arrowUp" === e.target.className ? ye.changeYear(ye.currentYear + 1) : "arrowDown" === e.target.className && ye.changeYear(ye.currentYear - 1)
        }
        function fe(e, t, n) {
...
default = Object.create(i.l10ns.en),
    ...
    i.prototype = {
        ...
        parseDate: function(e, t, n) {
            ...
            return e instanceof Date ? (this.config && this.config.utc && !e.fp_isUTC && (e = e.fp_toUTC()), !0 === n && e.setHours(0, 0, 0, 0), e) : (console.warn("flatpickr: invalid date " + o), console.info(this.element), null)
        }
    },
